        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <input type="file" class="form-control" id="csvFile" name="csvFile" accept=".csv,.xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" required>
            </div>
            <div class="form-text">
...
<!-- Modal For Display Coordinator Details-->
<div class="modal fade" id="viewAccModal" tabindex="-1" role="dialog" aria-labelledby="viewAccModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg"> <!-- Optional: modal-lg -->
    <div class="modal-content">
      <div class="modal-header bg-primary text-white">
      ...
      <div class="modal-body" id="viewAccBody">
        <!-- Student info will be shown here -->
      </div>
      <div class="modal-footer">
       <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="editAccModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <form id="editAccForm" class="modal-content">
      <div class="modal-header bg-primary text-white">
        <h5 class="modal-title">Edit Coordinator</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <input type="hidden" name="ac_id" id="edit_acc_id">

        <div class="mb-2">
          <label for="edit_acc_name">Name:</label>
          <input type="text" class="form-control" name="ac_name" id="edit_acc_name">
        </div>

        <div class="mb-2">
          <label for="edit_acc_email">Email:</label>
          <input type="email" class="form-control" name="ac_email" id="edit_acc_email">
        </div>

        <div class="mb-2">
          <label for="edit_acc_phoneno">Phone No:</label>
          <input type="number" class="form-control" name="ac_phoneno" id="edit_acc_phoneno">
        </div>

        <div class="mb-2">
          <label for="edit_acc_password">Password:</label>
          <input type="text" class="form-control" name="ac_password" id="edit_acc_password">
        </div>

        <div class="mb-2">
          <label for="edit_acc_department">School:</label>
          <select class="form-control" name="ac_department" id="edit_acc_department">
            <!-- Options will be populated dynamically -->
          </select>
        </div>
      </div>
